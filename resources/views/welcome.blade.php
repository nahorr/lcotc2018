                    ...
                    <div class="container">
                        <div class="call-to-action">
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="text-center">
                                        <a href="{{url('/registration')}}" class="btn btn-default btn-lg">Register Now</a>
                                    </div>
                                </div>
                            </div>
                              <!-- ================ -->
                            ...
                            <div class="tabs-style-2">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade" id="h2tab4">
                                        ...
                                        <div class="col-md-12 text-center">
                                            <a href="{{url('/registration')}}" class="btn btn-default btn-lg">Register</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
